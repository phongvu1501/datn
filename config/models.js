...
module.exports.models = {
  ...
  ***************************************************************************/
  ...
  migrate: 'safe', // 'safe', 'alter', or 'drop'. 

  // safe : chế độ an toàn, không tự động tạo bảng
  // alter : tự động tạo bảng nếu chưa có
  // drop : tự động xóa bảng và tạo lại bảng mới
  // (Note: `migrate: 'safe'` is the default in production.)
  // (Note: `migrate: 'drop'` is the default in testing.)
  ...
  ******************************************************************************/
  ...
  dataEncryptionKeys: {
    default: 'jj/PknHZABCBZGEK2RS+TjtlEmjw+8RmvUnnQjjo0Lw='
  },
